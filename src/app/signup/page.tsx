    ...
    <main className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl p-8 bg-white/5 border border-white/10">
          ...
          <p className="text-gray-400 mb-8">Start your flow state journey today</p>

          {/* Google Signup */}
          <button
            onClick={handleGoogleSignup}
            disabled={isLoading}
            className="w-full py-3 px-4 rounded-xl bg-white text-gray-800 font-medium hover:bg-gray-100 transition-colors flex items-center justify-center gap-3 mb-6 disabled:opacity-50"
          >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#0a0a0a] text-gray-500">or sign up with email</span>
            </div>
          </div>
